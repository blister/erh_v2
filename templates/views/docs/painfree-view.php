<title>$Painfree->view() - Documentation | PHPainfree2</title>

<div class="text-center mt-5 mb-5">
	<h2 class="fw-bolder">PHPainfree<code>2</code> 
		<code class="language-php">$Painfree->view()</code>
	</h2>
	<p class="lead mb-0">
		<code class="language-php">$Painfree->view() : void</code>
	</p>
</div>
...
<pre class="line-numbers" data-start="37"><code class="language-php">
include $Painfree->view(); // load the application logic controller
</code></pre>
<pre class="line-numbers" data-start="55"><code class="language-php">
public function view() : void {
	...
	<div class="col-lg-6">
		<div class="card bg-dark border-warning mb-4">
			<div class="card-header fs-4 font-monospace">$Painfree->view()</div>
			<div class="card-body p-4">
				<table class="table table-striped table-dark">
					...
					<tbody>
						<tr>
							...
							<td><code class="language-php">$PainfreeConfig['TemplateFolder'];</code></td>
						</tr>
						<tr>
							<td scope="row">Configured</td>
							<td><span class="font-monospace">PainfreeConfig.php</span></td>
